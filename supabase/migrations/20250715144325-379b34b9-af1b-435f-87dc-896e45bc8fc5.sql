-- Insert privacy policy hero section
...
-- Insert privacy policy body content
INSERT INTO public.website_content (
  section_key,
  title,
  description,
...
Usage Information We automatically collect certain information about your use of our services:
