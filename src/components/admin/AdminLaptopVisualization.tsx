    ...
    <div className="flex justify-center bg-gray-900">
      <div className={`relative transition-all duration-1500 ${
        ...
        <div className="relative" style={{ perspective: '2000px', perspectiveOrigin: 'center center' }}>
          ...
          {/* Floating Icons - Close to laptop edges */}
          {/* Top right */}
          <div className="absolute w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center animate-float shadow-2xl" style={{ top: '-180px', right: '-40px', animationDelay: '1s' }}>
            <BarChart className="h-7 w-7 text-white" />
          </div>
          
          {/* Top left */}
          <div className="absolute w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center animate-float shadow-2xl" style={{ top: '-180px', left: '-40px', animationDelay: '2s' }}>
            <Monitor className="h-7 w-7 text-white" />
          </div>
          
          {/* Right side */}
          <div className="absolute w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center animate-float shadow-xl" style={{ top: '-50px', right: '-30px', animationDelay: '3s' }}>
            <Shield className="h-6 w-6 text-white" />
          </div>
          
          {/* Left side */}
          <div className="absolute w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center animate-float shadow-xl" style={{ top: '-50px', left: '-30px', animationDelay: '4s' }}>
