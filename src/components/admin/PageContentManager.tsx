  ...
  const loadContent = async () => {
    try {
      ...
      if (selectedPage === 'home') {
        ...
        // For data security page, show hero and body sections only
        query = query.or(`section_key.eq.security_hero,section_key.eq.security_body`);
      } else {
